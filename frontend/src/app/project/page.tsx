...
import { Plus, Search, Filter, Grid, List, MoreVertical, Users, Star, X } from 'lucide-react';

const JiraProjectsGrid = () => {
  const [projects, setProjects] = useState([
    { id: 1, name: 'E-commerce Platform', key: 'ECP', type: 'Software', members: 12, issues: 45, progress: 78, starred: true, color: 'bg-gradient-to-br from-blue-400 to-blue-600' },
    { id: 2, name: 'Mobile App Redesign', key: 'MAR', type: 'Design', members: 8, issues: 23, progress: 45, starred: false, color: 'bg-gradient-to-br from-purple-400 to-purple-600' },
    { id: 3, name: 'Data Analytics Dashboard', key: 'DAD', type: 'Analytics', members: 6, issues: 17, progress: 92, starred: true, color: 'bg-gradient-to-br from-green-400 to-green-600' },
    { id: 4, name: 'Customer Support Portal', key: 'CSP', type: 'Software', members: 10, issues: 31, progress: 65, starred: false, color: 'bg-gradient-to-br from-orange-400 to-orange-600' },
    { id: 5, name: 'Marketing Campaign', key: 'MC', type: 'Marketing', members: 5, issues: 12, progress: 34, starred: false, color: 'bg-gradient-to-br from-pink-400 to-pink-600' },
    { id: 6, name: 'API Integration', key: 'API', type: 'Backend', members: 4, issues: 19, progress: 87, starred: true, color: 'bg-gradient-to-br from-teal-400 to-teal-600' },
    { id: 7, name: 'Security Audit', key: 'SA', type: 'Security', members: 3, issues: 8, progress: 23, starred: false, color: 'bg-gradient-to-br from-red-400 to-red-600' },
    { id: 8, name: 'Performance Optimization', key: 'PO', type: 'DevOps', members: 7, issues: 25, progress: 56, starred: false, color: 'bg-gradient-to-br from-indigo-400 to-indigo-600' },
    { id: 9, name: 'Performance Optimization', key: 'POO', type: 'DevOps', members: 5, issues: 245, progress: 96, starred: false, color: 'bg-gradient-to-br from-pink-400 to-black-600' } 
  ]);
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                  <p className="text-xs text-gray-500 mt-1">Number of team members working on this project</p>
                </div>
              </div>
